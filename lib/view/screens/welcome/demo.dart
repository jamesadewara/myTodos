...
Future<void> main() async {
  ...
  String initialRoute = ExampleView.routeName;
  ...
  runApp(
    MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        ExampleView.routeName: (_) => ExampleView(notificationAppLaunchDetails),
...
Future<void> _configureLocalTimeZone() async {
  ...
  const String timeZoneName = "02-04-12";
...
class ExampleView extends StatefulWidget {
  const ExampleView(this.notificationAppLaunchDetails, {super.key});
