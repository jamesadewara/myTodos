...
import 'package:mytodo/src/view/custom_widgets/file_field.dart';
            ...
            Row(
              ...
              children: [
                FilledButton(
                    ...
                    child: Text(context.tr("createCustomGroupText")))
              ],
            ),
            const SizedBox(
              height: 8,
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    title: Text(context.tr("galleryText")),
                  ),
                  const SizedBox(
                    height: 8,
                  ),
                  ListTile(
                    ...
                    title: Text(context.tr("cameraText")),
                  )
                ],
              ),
            )));
...
class _CreateGroupDropdownModalState extends State<CreateGroupDropdownModal> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
        ...
        elevation: 2,
        title: Text(context.tr("createCustomGroupText")),
        content: Container(
            width: ResponsiveBreakpoints.of(context).between(MOBILE, TABLET)
                ? null
                : 360,
                          ...
                          child: Column(
                            ...
                            TextFormField(
                                ...
                                decoration: InputDecoration(
                                  hintText: context.tr("groupNameHint"),
                                ),
                                obscureText: false,
                                validator: (value) {
                            ...
                            TextFormField(
                                ...
                                keyboardType: TextInputType.text,
                                decoration: InputDecoration(
                                  hintText: context.tr("groupDescriptionHint"),
                                ),
                                obscureText: false,
                                validator: (value) {
                                  return validateField(value, context: context);
                            ...
                            FileField(
                                title: context.tr("selectText"),
                                decoration: BoxDecoration(
                                    borderRadius: const BorderRadius.all(
                                        Radius.circular(8)),
                                    color:
                                        Theme.of(context).colorScheme.surface),
                                hintText: context.tr("groupImageHint"),
                                onTap: () {})
                          ]))),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    ...
                    children: [
                      ...
                      FilledButton(
                          ...
                          child: Text(context.tr("createText")))
                    ],
                  ),
                ])));
  }
                      ...
                      child: Expanded(
                          child: Column(
                            ...
                            TextFormField(
                              controller: subtitleController,
                              decoration: InputDecoration(
                                hintText: context.tr("subtitleHint"),
                              ),
                              maxLength: 250,
                              maxLengthEnforcement:
                                  MaxLengthEnforcement.enforced,
